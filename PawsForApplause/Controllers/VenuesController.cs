...
namespace PawsForApplause.Controllers
{
    ...
    public class VenuesController : Controller
    {
        ...
        public VenuesController(PawsForApplauseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VenueId,Name,Address,City,Province,PostalCode,Capacity,Created")] Venue venue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,Name,Address,City,Province,PostalCode,Capacity,Created")] Venue venue)
        {
            if (id != venue.VenueId)
            {
                return NotFound();
